...
namespace brilliance\launcherassistant\ai;

use brilliance\launcherassistant\ai\providers\BaseAIProvider;
use brilliance\launcherassistant\ai\providers\ClaudeProvider;
...
class AIProviderFactory
{
    ...
    public static function create(?string $provider = null): ?BaseAIProvider
    {
        ...
        $providerName = $provider ?? LauncherAssistant::$plugin->aiSettingsService->getProviderName();
    ...
    private static function getApiKey(string $provider): string
    {
        ...
        return LauncherAssistant::$plugin->aiSettingsService->getApiKey($provider) ?? '';
    }
