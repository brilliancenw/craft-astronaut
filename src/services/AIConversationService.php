...
use brilliance\launcherassistant\ai\providers\AIResponse;
use brilliance\launcherassistant\LauncherAssistant;
use brilliance\launcherassistant\records\AIConversationRecord;
use brilliance\launcherassistant\records\AIMessageRecord;
use Craft;
...
class AIConversationService extends Component
{
    ...
    public function sendMessage(string $threadId, string $userMessage): array
    {
        ...
        $contextService = LauncherAssistant::$plugin->craftContextService;
        $toolService = LauncherAssistant::$plugin->aiToolService;
